const swiper = () => {
  ...
  var H = {
      ...
      updateSlidesClasses: function() {
          ...
          o && (n || (c = function(e, t) {
           ...
           swiper - slide`)[0], s.loop && !c && (c = t[0]), d = function(e, t) {
              const s = [];
           ...
           swiper - slide`)[0], s.loop && 0 === !d && (d = t[t.length - 1]))),
          t.forEach((e => {
  ...
  var B = {
      ...
      slideReset: function(e, t, s) {
          void 0 === t && (t = !0);
          const a = this;
          if (!a.destroyed) return void 0 === e && (e = a.params.speed),
  ...
  const fe = [function(e) {
      ...
      function c(e, t) {
          ...
          for (let e = u; e <= m; e += 1) if (e < x || e > S) {
              const t = L(e);
  ...
  function(e) {
      ...
      a("init", (() => { ! 1 === t.params.navigation.enabled ? u() : (c(), l())
      })),
  ...
  function(e) {
      ...
      function p() {
          ...
          if (t.params.loop ? (r = t.previousRealIndex || 0, a = t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex) : void 0 !== t.snapIndex ? (a = t.snapIndex, r = t.previousSnapIndex) : (r = t.previousIndex || 0, a = t.activeIndex || 0), "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
              ...
              if (s.dynamicBullets && (n = S(i[0], t.isHorizontal() ? "width" : "height", !0), c.forEach((e => {
                  ...
                  s.dynamicBullets && (i >= o && i <= p && e.classList.add(.`$ {
                      s.bulletActiveClass
                  } - main`.split(" ")), i === o && d(e, "prev"), i === p && d(e, "next"))
              }));
              else {
                  const e = i[a];
                  if (e && e.classList.add(.s.bulletActiveClass.split(" ")), t.isElement && i.forEach(((e, t) => {
                      ...
                      const e = i[o],
                      t = i[p];
                      for (let e = o; e <= p; e += 1) i[e] && i[e].classList.add(.`$ {
                          s.bulletActiveClass
                      } - main`.split(" "));
                      d(e, "prev"),
                      d(t, "next")
      ...
      function u() {
          ...
          a("init", (() => { ! 1 === t.params.pagination.enabled ? f() : (m(), u(), p())
          })),
          a("activeIndexChange", (() => {
      ...
      function(e) {
          ...
          i("init", (() => { ! 1 === t.params.scrollbar.enabled ? I() : (P(), b(), g())
          })),
      ...
      function(e) {
          ...
          function M(e) {
              ...
              i >= 0 && (u[i] = e),
              u.length < 2 || (o = !0, m.scaleMove = y(), m.imageEl && (a.scale = m.scaleMove / m.scaleStart * c, a.scale > m.maxRatio && (a.scale = m.maxRatio - 1 + (a.scale - m.maxRatio + 1) * *.5), a.scale < s.minRatio && (a.scale = s.minRatio + 1 - (s.minRatio - a.scale + 1) * *.5), m.imageEl.style.transform = `translate3d(0, 0, 0) scale($ {
                  a.scale
              })`))
          }
          function C(e) {
      ...
      function(e) {
          ...
          I = () => {
              ...
              const i = t.wrapperEl,
              r = e.id || i.getAttribute("id") || `swiper - wrapper - $ {
                  n = 16,
                  void 0 === n && (n = 16),
      ...
      function(e) {
          ...
          n("sliderFirstMove", (() => { ! i.destroyed && i.autoplay.running && (i.params.autoplay.disableOnInteraction ? T() : (p = !0, u = !1, f = !1, m = setTimeout((() => {
                  f = !0,
                  u = !0,
                  M(!0)
              }), 200)))
          ...
          pe({
              ...
              setTranslate: () => {
                  ...
                  for (let r = 0; r < e.length; r += 1) {
                      ...
                      t.browser && t.browser.need3dFix && (Math.abs(d) / 90 % 2 == 1 && (d += .001), Math.abs(c) / 90 % 2 == 1 && (c += .001)),
